...
| `GET /v1/foods/{slug}` | Ingredient detail: nutrition, allergens, "may contain" traces and trace status (`unknown` / `none_declared` / `declared`; all incl. inherited), portions, packages |
